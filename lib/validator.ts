...
export const OrderInputSchema = z.object({
  ...
  deliveryCharge: Price('Delivery price'),
...
export const DeliveryDateSchema = z.object({
  ...
  deliveryCharge: z.coerce.number().min(0, 'Delivery price must be at least 0'),
  freeDeliveryMinCharge: z.coerce
    .number()
    .min(0, 'Free delivery min amount must be at least 0'),
})
